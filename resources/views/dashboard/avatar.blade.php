...
@section('css')
<!---Internal  Prism css-->
<link href="{{URL::asset('plugins/prism/prism.css')}}" rel="stylesheet">
<!--- Custom-scroll -->
<link href="{{URL::asset('plugins/custom-scroll/jquery.mCustomScrollbar.css')}}" rel="stylesheet">
@endsection
@section('page-header')
				<!-- breadcrumb -->
									...
									<div class="example">
										<div class="demo-avatar-group">
											<div class="main-img-user avatar-xs">
												<img alt="avatar" class="rounded-circle" src="{{URL::asset('img/faces/2.jpg')}}">
											</div>
											<div class="main-img-user avatar-sm">
												<img alt="avatar" class="rounded-circle" src="{{URL::asset('img/faces/3.jpg')}}">
											</div>
											<div class="main-img-user">
												<img alt="avatar" class="rounded-circle" src="{{URL::asset('img/faces/4.jpg')}}">
											</div>
											<div class="main-img-user avatar-md">
												<img alt="avatar" class="rounded-circle" src="{{URL::asset('img/faces/5.jpg')}}">
											</div>
											<div class="main-img-user avatar-lg">
												<img alt="avatar" class="rounded-circle" src="{{URL::asset('img/faces/6.jpg')}}">
											</div>
											<div class="main-img-user avatar-xl d-none d-sm-block">
												<img alt="avatar" class="rounded-circle" src="{{URL::asset('img/faces/7.jpg')}}">
											</div>
											<div class="main-img-user avatar-xxl d-none d-sm-block">
												<img alt="avatar" class="rounded-circle" src="{{URL::asset('img/faces/8.jpg')}}">
											</div>
										</div>
									</div>
								...
								<div class="text-wrap">
									<div class="example">
										<div class="demo-avatar-group">
											...
											<div class="main-img-user avatar-md">
												<img alt="avatar" class="square" src="{{URL::asset('img/faces/5.jpg')}}">
											</div>
											<div class="main-img-user avatar-md">
												<img alt="avatar" class="radius" src="{{URL::asset('img/faces/6.jpg')}}">
											</div>
										</div>
									</div>
										...
										<div class="example">
											<div class="demo-avatar-group">
												<div class="main-avatar avatar online">
													<img alt="avatar" class="rounded-circle avatar" src="{{URL::asset('img/faces/9.jpg')}}">
												</div>
...
<script src="{{URL::asset('plugins/custom-scroll/jquery.mCustomScrollbar.concat.min.js')}}"></script>
<!--Internal  Clipboard js-->
<script src="{{URL::asset('plugins/clipboard/clipboard.min.js')}}"></script>
<script src="{{URL::asset('plugins/clipboard/clipboard.js')}}"></script>
<!-- Internal Prism js-->
