								...
								<li class="">
									<div class="dropdown  nav-itemd-none d-md-flex">
										<a href="#" class="d-flex  nav-item nav-link pl-0 country-flag1" data-toggle="dropdown" aria-expanded="false">
											<span class="avatar country-Flag mr-0 align-self-center bg-transparent"><img src="{{URL::asset('dashboard/img/flags/'.App::getLocale().'.jpg')}}" alt="img"></span>
											{{-- <div class="my-auto">
											...
											<div class="dropdown-menu dropdown-menu-left dropdown-menu-arrow" x-placement="bottom-end">
												{{-- @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
													<a rel="alternate" hreflang="{{ $localeCode }}" href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}" class="dropdown-item d-flex ">
														<span class="avatar  ml-3 align-self-center bg-transparent"><img src="{{URL::asset('dashboard/img/flags/'.$localeCode.'.jpg')}}" alt="img"></span>
														<div class="d-flex">
						...
						<div class="nav nav-item  navbar-nav-right ml-auto">
							...
							<div class="dropdown main-profile-menu nav nav-item nav-link">
								...
								<div class="dropdown-menu">
									...
									{{-- @if (auth("admin")->check())
									<form class="dropdown-item" action="{{ route('logout.admin') }}" 
									method="post" onclick="event.preventDefault();
									...
									@else --}}
									<form class="dropdown-item" action="{{ route('logout') }}" 
									method="post" onclick="event.preventDefault();
									this.closest('form').submit();">
										@csrf
										<i class="bx bx-log-out"></i> Sign Out
